...
int main()
{
    ...
    srcImage_base = imread("images/41.jpg", cv::IMREAD_COLOR);
    srcImage_test1 = imread("images/42.jpg", cv::IMREAD_COLOR);
    srcImage_test2 = imread("images/43.jpg", cv::IMREAD_COLOR);
    // 显示载入的3张图像
